...
export function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  return (
    <aside className={cn("w-full bg-white h-full flex flex-col border-r border-gray-100", isOpen ? "overflow-y-auto" : "overflow-visible")}>
      {/* Logo */}
      <div className={cn("p-6 flex items-center", isOpen ? "gap-3" : "justify-center px-4")}>
      ...
      <div className="p-4 mt-auto">
        {isOpen ? (
          ...
          <button onClick={onToggle} className="hidden lg:block p-2 text-gray-400 hover:text-blue-600 hover:bg-blue-50 rounded-xl transition-colors">
