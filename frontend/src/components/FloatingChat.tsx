...
export function FloatingChat({
  ...
  if (isMinimized) {
    return (
      <div className="fixed z-[100] group cursor-pointer transition-all duration-300" style={{ bottom: 16 + index * 70, right: 380 }} onClick={() => onMaximize && onMaximize()}>
  ...
  return (
    <div className="fixed bottom-0 bg-white border border-gray-200 rounded-t-xl shadow-2xl flex flex-col z-[100] transition-all w-[320px] h-[450px]" style={{ right: 380 + index * 340 }}>
