...
export function BeginnerSpeakingDetail() {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto px-4 py-8 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="bg-white rounded-3xl p-6 md:p-8 border-2 border-green-100 shadow-xl w-full text-center">
        ...
        <div className="bg-slate-50 rounded-2xl p-6 md:p-8 mb-8 border border-slate-100 min-h-[140px] md:min-h-[160px] flex items-center justify-center">
          <h2 className="text-2xl md:text-3xl font-black text-slate-800 leading-tight">{currentSentence}</h2>
        </div>

        {/* Results */}
        {(status === "correct" || status === "wrong") && result && (
          <div className="mb-8 p-5 md:p-6 bg-green-50 rounded-2xl border border-green-200 animate-in zoom-in-95">
