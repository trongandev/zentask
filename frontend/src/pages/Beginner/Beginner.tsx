        ...
        <div className="w-full max-w-5xl mx-auto min-h-screen bg-slate-50/50 font-sans pb-24 relative overflow-hidden flex flex-col items-center">
            ...
            {!isLoading && roadmap && totalPhases > 1 && (
                <div className="flex justify-center w-full max-w-lg px-4 mb-2 z-30 relative gap-4">
                    <Button 
                        variant="secondary"
                        size="sm"
                        disabled={viewPhaseIndex === 0}
                        onClick={() => setViewPhaseIndex(p => Math.max(0, p - 1))}
                    ...
                    roadmap.days.slice(viewPhaseIndex * 7, (viewPhaseIndex + 1) * 7).map((dayData, index) => {
                        ...
                        return (
                            <div 
                                ...
                                className={`w-full flex flex-col items-center relative z-10 ${index === 0 ? "mt-4" : ""}`}
                            >
            ...
            {selectedDay && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
                    <div 
                        className="bg-white rounded-[2rem] w-full max-w-sm shadow-2xl flex flex-col overflow-hidden animate-in fade-in zoom-in-95 duration-200"
                    ...
                    >
                        ...
                        <div className="p-6 bg-slate-50/80 border-t border-slate-100">
                            ...
                            >
                                <Play className="w-6 h-6 fill-current" /> BẮT ĐẦU HỌC
                            </Button>
                        </div>
                    </div>
                </div>
            ...
            {showWaitTomorrowModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-sm">
                    <div className="bg-white rounded-3xl p-6 md:p-8 max-w-md w-full shadow-2xl relative animate-in zoom-in-95 duration-200">
                        <button
                            onClick={() => setShowWaitTomorrowModal(false)}
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <p className="text-slate-600 mb-4 font-medium leading-relaxed">
                                Theo nghiên cứu khoa học, việc <strong>dừng lại đúng lúc</strong> khi bạn đang cực kỳ hứng thú sẽ tạo ra hiệu ứng Zeigarnik – một cảm giác thèm thuồng khiến bộ não của bạn ghi nhớ kiến thức sâu hơn và tự động thôi thúc bạn quay lại học tiếp vào ngày hôm sau.
                            </p>
                            ...
                            <Button
                                onClick={() => setShowWaitTomorrowModal(false)}
                                className="w-full py-6 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-bold text-lg shadow-lg shadow-blue-600/30"
                            >
