      ...
      <div className="bg-white rounded-3xl p-8 border-2 border-blue-100 shadow-xl w-full">
        ...
        <div className="mb-6">
          <textarea
            ...
            className="w-full h-64 p-6 bg-slate-50 border-2 border-slate-200 rounded-2xl focus:border-blue-500 focus:ring-4 focus:ring-blue-500/20 outline-none transition-all resize-none text-lg text-slate-800 custom-scrollbar disabled:opacity-70 disabled:cursor-not-allowed"
          />
        ...
        {/* Feedback */}
        {feedback && (
          <div className="bg-green-50 rounded-2xl p-6 border border-green-200 mb-8 animate-in zoom-in-95 duration-300">
