  ...
  return (
    <div className="flex flex-col items-center z-10 w-full max-w-4xl px-4 animate-in fade-in zoom-in duration-500">
      <div className="w-32 h-32 md:w-40 md:h-40 mb-2">
        {isWin ? (
          <img
            src="/mascot/Lopy (1).png"
            className="w-full h-full object-contain animate-bounce drop-shadow-[0_0_20px_rgba(250,204,21,0.5)]"
          />
        ) : isLose ? (
      ...
      <h2
        className={cn(
          ...
          isWin ? "text-yellow-400" : isLose ? "text-gray-400" : "text-blue-400",
        )}
      >
      ...
      {rankUpdateStatus === "protected" && (
        <p className="text-blue-300 font-bold text-lg md:text-xl mb-6 md:mb-8">Bảo hiểm: Không trừ sao</p>
      )}
      {rankUpdateStatus === "tournament" && (
        <p className="text-yellow-200 font-bold text-lg md:text-xl mb-6 md:mb-8">Giải đấu: +10XP, không tính rank</p>
      )}
      ...
      <div className="flex flex-row items-center gap-6 md:gap-12 bg-white/5 p-4 md:p-6 rounded-3xl border border-white/10 backdrop-blur-md shadow-2xl">
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-blue-500 mb-2 object-cover"
          />
        ...
        <div className="flex flex-col items-center">
          <img
            ...
            className="w-16 h-16 md:w-20 md:h-20 rounded-full border-4 border-red-500 mb-2 object-cover"
          />
      ...
      <div className="mt-8 md:mt-12 flex flex-col md:flex-row gap-4 w-full md:w-auto">
        <button
          onClick={() => navigate("/")}
          className="w-full md:w-auto px-8 py-4 bg-white/10 hover:bg-white/20 text-white font-bold rounded-2xl transition-all text-center"
        >
          Về trang chủ
        </button>
        <button
