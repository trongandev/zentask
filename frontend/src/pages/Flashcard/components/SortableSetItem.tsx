  ...
  return (
    ...
    >
      ...
      <div className="mt-auto">
        {cardCount > 0 && (
          <div className="mb-4">
            <div className="flex justify-between text-[11px] font-bold text-slate-500 mb-2 px-0.5">
        ...
        <Button className="w-full py-2.5 flex items-center justify-center gap-2 text-sm font-bold text-slate-700 bg-slate-50 border border-slate-200 hover:bg-white hover:border-slate-300 hover:text-slate-900 hover:shadow-sm rounded-xl transition-all pointer-events-none group-hover:bg-blue-600 group-hover:text-white group-hover:border-blue-600">
