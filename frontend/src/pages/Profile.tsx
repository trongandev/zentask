...
export function Profile() {
    ...
    useEffect(() => {
        if (activeTab === "ranks" && !rankConfig) {
            axiosInstance
                .get(`/api/beginner/ranks?lang=en`)
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex gap-4">
                                <div
                                    ...
                                    className="flex-1 bg-white shadow-sm rounded-2xl p-4 border border-gray-100 text-center cursor-pointer hover:bg-gray-50 transition-colors">
                            ...
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {user.achievedBadges.length > 5 && (
                                        <div className="w-12 h-12 rounded-xl flex items-center justify-center text-sm font-bold bg-gray-50 text-gray-500 border border-gray-200">
                                            +{user.achievedBadges.length - 5}
                                        </div>
                                    )}
                                </div>
                                        ...
                                        <div key={activity.id} className="relative pl-8">
                                            ...
                                            <div className={`rounded-2xl p-5 border border-gray-100 hover:bg-white hover:shadow-md hover:border-gray-200 transition-all ${style.bg}`}>
                                                <div className="flex items-start justify-between gap-4 mb-2">
                                                    ...
                                                    {activity.xpEarned > 0 && (
                                                        <span className="px-3 py-1 bg-yellow-100 text-yellow-700 text-xs font-bold rounded-lg whitespace-nowrap">+{activity.xpEarned} XP</span>
                                                    )}
                                                </div>
                                                            ...
                                                            <div
                                                                ...
                                                                <div className="text-xs text-gray-600 mt-2 flex-1">
                                                                    ...
                                                                    <ul className="list-disc pl-4 space-y-1">
                                                                        {tier.data && tier.data.map((topic: any, i: number) => <li key={i}>{topic.title}</li>)}
                                                                    </ul>
                                                                </div>
