                ...
                <div className="grid w-full max-w-[1100px] overflow-hidden rounded-[1.5rem] sm:rounded-[2.5rem] border border-white/15 bg-white/10 shadow-2xl shadow-black/40 backdrop-blur-2xl lg:grid-cols-[1.1fr_0.9fr]">
                    <section className="relative hidden h-full flex-col justify-between overflow-hidden bg-slate-900/70 p-8 sm:p-10 lg:flex lg:p-12 text-white">
                        ...
                        <div className="relative z-10">
                            ...
                            <div className="max-w-xl">
                                <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-bold text-blue-50 backdrop-blur-md">
                                    <Sparkles className="h-4 w-4 text-yellow-300" />
                                    Học đều hơn, nhớ lâu hơn, vui hơn mỗi ngày
                                </div>
                                <h2 className="text-4xl sm:text-5xl font-black leading-[1.15] tracking-tight">Tất cả công cụ học tiếng Anh trong một nền tảng.</h2>
                        ...
                        <div className="relative z-10 mt-10 lg:mt-auto pt-8">
                            <div className="rounded-[2rem] border border-white/10 bg-white/5 p-4 sm:p-5 shadow-xl shadow-black/20 backdrop-blur-md">
                                <div className="flex items-center gap-4">
                                    <div className="relative flex h-20 w-20 sm:h-24 sm:w-24 shrink-0 items-center justify-center rounded-[1.5rem] sm:rounded-3xl bg-white/95 shadow-xl">
                                        <img
                                            src={MASCOT_SRC}
                                            alt="Mascot ZenTask"
                                ...
                                <div>
                                    <p className="text-xs sm:text-sm font-bold uppercase tracking-[0.2em] text-blue-300/80">Lopy gợi ý</p>
                                    <p className="mt-1.5 text-sm sm:text-base font-semibold leading-relaxed text-white">
                    ...
                    <section className="relative flex flex-col justify-center bg-white px-5 py-8 sm:px-10 sm:py-12 lg:px-12">
                        <div className="mx-auto flex w-full max-w-[420px] flex-col justify-center">
                            ...
                            <div className="mb-8">
                                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-blue-50/80 px-3 py-1.5 text-xs font-bold text-blue-700 ring-1 ring-blue-500/20">
