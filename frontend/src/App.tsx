...
function MainLayout() {
    ...
    return (
      ...
      `}>
            ...
            {!isPracticePage && (
                <div
                    className={`transition-all duration-300 ease-in-out hidden lg:block flex-shrink-0 relative z-50 bg-white border-l border-gray-100 ${isRightSidebarOpen ? "w-[320px]" : "w-[88px]"}`}>
