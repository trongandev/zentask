      ...
      <div className="bg-white rounded-3xl overflow-hidden shadow-sm border border-gray-100">
        ...
        <div className="p-8 md:p-12">
          <div className="flex items-center gap-4 mb-6">
            <span className="px-4 py-1.5 rounded-full text-sm font-bold bg-blue-50 text-blue-600">
              {post.category}
            </span>
          ...
          <div className="prose prose-lg max-w-none text-gray-700 leading-relaxed space-y-6">
            ...
            <p>
              Đây là nội dung chi tiết giả lập cho bài viết. Trong thực tế, nội dung này sẽ được tải từ database 
              chứa đầy đủ các đoạn văn, hình ảnh minh họa, trích dẫn, và các thành phần HTML khác.
            </p>
            <p>
              Việc duy trì thói quen học tập đóng vai trò rất quan trọng trong việc tiếp thu kiến thức mới. 
              Hãy đặt ra các mục tiêu nhỏ mỗi ngày để đạt được kết quả lớn trong dài hạn.
            </p>
            <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100 my-8">
              ...
              <p className="text-blue-800 m-0">Sử dụng phương pháp Spaced Repetition (Lặp lại ngắt quãng) kết hợp với Flashcard sẽ giúp bạn ghi nhớ từ vựng lâu hơn gấp 3 lần so với cách học truyền thống.</p>
            </div>
            <p>
              Cuối cùng, đừng quên nghỉ ngơi hợp lý. Não bộ cần thời gian để tổng hợp và lưu trữ thông tin sau 
              mỗi phiên học căng thẳng.
            </p>
          </div>
        </div>
      </div>
