...
export function Arena() {
  ...
  const startSearch = (selectedMode: "solo" | "team2v2" = "solo") => {
    ...
    socket.emit("find_arena_match", {
      mode: selectedMode,
      user: { uid: user.uid, name: user.displayName || "User", avatar: user.photoURL, rankInfo: readableRankInfo, rankId, tier: tierNum, arenaMatchesPlayed: (user as any).arenaMatchesPlayed || 0 },
      matchData: deck,
    });
